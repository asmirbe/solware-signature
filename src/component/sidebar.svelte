<script>
	...
	async function handleSubmit(event) {
		...
		if (!$user.features.previewImage) notifications.warning('Un avatar est requis', 2000)
...
<nav>
	<aside class="sidebar" bind:this={viewport}>
		<div class="content" bind:this={contents}>
			...
			{#if showMore}
				<div transition:slide={{ duration: 300 }} class="more">
					<div class="field">
			...
			<footer>
				<div class="buttons-group">
					<div class="field -inline -rgpd" use:tooltip title={txtApp.infoRgpd}>
