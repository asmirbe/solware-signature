<script>
	...
	function saveOrRemoveData() {
		if ($user.saved) {
			resetToDefault();
			console.log("Called removeUser function");
		} else {
			saveData();
			console.log("Called saveData function");
		}
	}
	...
	const formatPhone = (e, userOptionSetter) => {
		...
		<div>
			...
			<footer>
				...
				<div class="desc">
					...
					<a href="https://teams.microsoft.com/l/chat/0/0?users=abelkic@solware.fr" class="btn -secondary -teams">
					...
					<tbody>
						<tr>
							...
							<td style="vertical-align: top; text-align:left;color:#000000; text-align:left">
								<span style="display: block; padding-top: 10px; line-height:1; color:#000000;font-size:15px; font-weight: bold;">
									{$user.name}
								</span>
								<span style="margin: .5em 0;color:#4C4C4C; display:block; font-weight:500;">
									{$user.position} @
								...
								{#if $user.phone}
									<span style="color:#8C8C8C!important;margin: 6px 0 0;">
										<a href="tel:{$user.phone}" data-external="true" style="text-decoration:none !important;color: rgb(140, 140, 140);">
											Fixe <span style="text-decoration: none;color: #4c4c4c;">{$user.phone}</span>
										</a>
										{#if $user.mobilePhoneCheckbox && $user.mobilePhone.length}
											...
											<a href="tel:{$user.mobilePhone}" data-external="true" style="text-decoration:none !important;color: rgb(140, 140, 140);">
												Mob. <span style="text-decoration: none;color: #4c4c4c;">{$user.mobilePhone}</span>
											</a>
										{/if}
									</span>
								{/if}
								...
								{#if $user.email}
									<a href="mailto:{$user.phone}" data-external="true" style="display: block; text-decoration:none !important;margin: 6px 0 0;color: rgb(140, 140, 140);">
										<span style="text-decoration:none;color: rgb(140, 140, 140);">{$user.email}</span>
									</a>
								{/if}
								<span
									style="color:#8C8C8C; line-height: 1.6; margin: 1em 0 0; display:inline-block;     font-size: 13px;
								font-weight: 500;"
								>
